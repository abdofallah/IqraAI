...
export declare class Model extends Basecoat<Model.EventArgs> {
    ...
    parseJSON(data: Model.FromJSONData): (Node<Node.Properties> | Edge<Edge.Properties>)[];
...
export declare namespace Model {
    ...
    function fromJSON(data: FromJSONData): (Node<Node.Properties> | Edge<Edge.Properties>)[];
}
