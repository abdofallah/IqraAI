    ...
    public class UserBusinessController : Controller
    {
        ...
        public async Task<FunctionReturnResult<BusinessData?>> GetUserBusinessMeta(long businessId)
        {
            ...
            try
            {
                ...
                {
                    return result.SetFailureResult(
                        $"GetUserBusinessMeta:{validationResult.Code}",
                        validationResult.Message
                    );
                }
                var businessData = validationResult.Data!.businessData!;
        ...
        public async Task<FunctionReturnResult<BusinessApp?>> GetUserBusinessApp(long businessId)
        {
            ...
            try
            {
                ...
                {
                    return result.SetFailureResult(
                        $"GetUserBusinessApp:{validationResult.Code}",
                        validationResult.Message
                    );
                }
                var userData = validationResult.Data!.userData!;
                ...
                {
                    return result.SetFailureResult(
                        $"GetUserBusinessApp:{businessAppResult.Code}",
                        businessAppResult.Message
                    );
                }

                return result.SetSuccessResult(businessAppResult.Data);
            }
            catch (Exception ex)
            {
                return result.SetFailureResult(
                    "GetUserBusinessApp:EXCEPTION",
                    $"Internal server error: {ex.Message}"
                );
            }
        }
        ...
        public async Task<FunctionReturnResult<List<BusinessWhiteLabelDomain>?>> GetUserBusinessWhiteLabelDomains(long businessId)
        {
            ...
            try
            {
                ...
                {
                    return result.SetFailureResult(
                        $"GetUserBusinessWhiteLabelDomains:{validationResult.Code}",
                        validationResult.Message
                    );
                }
                var userData = validationResult.Data!.userData!;
                ...
                {
                    return result.SetFailureResult(
                        $"GetUserBusinessWhiteLabelDomains:{businessWhiteLabelDomainResult.Code}",
                        businessWhiteLabelDomainResult.Message
                    );
                }

                return result.SetSuccessResult(businessWhiteLabelDomainResult.Data);
            }
            catch (Exception ex)
            {
                return result.SetFailureResult(
                    "GetUserBusinessWhiteLabelDomains:EXCEPTION",
                    $"Internal server error: {ex.Message}"
                );
            }
        }
