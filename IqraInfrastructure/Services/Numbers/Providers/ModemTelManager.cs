...
namespace IqraInfrastructure.Services.Numbers.Providers
{
    public class ModemTelManager
    {
        ...
        public async Task<FunctionReturnResult<bool>> ValidatePhoneNumberAsync(string apiKey, string apiBaseUrl, string phoneNumberId, bool requireCallCapability = true, bool requireSmsCapability = false)
        {
        ...
        public async Task<FunctionReturnResult<bool>> UpdateWebhookUrlAsync(string apiKey, string apiBaseUrl, string phoneNumberId, string webhookUrl)
        {
            var result = new FunctionReturnResult<bool>();
        ...
        public async Task<FunctionReturnResult<bool>> HangupCallAsync(string apiKey, string apiBaseUrl, string callId)
        {
            var result = new FunctionReturnResult<bool>();
        ...
        public async Task<FunctionReturnResult<bool>> SendDtmfAsync(string apiKey, string apiBaseUrl, string callId, string digits)
        {
            var result = new FunctionReturnResult<bool>();
        ...
        public async Task<FunctionReturnResult<bool>> AnswerCallAsync(string apiKey, string apiBaseUrl, string callId)
        {
            var result = new FunctionReturnResult<bool>();
