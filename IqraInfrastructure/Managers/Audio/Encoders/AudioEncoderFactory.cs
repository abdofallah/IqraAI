...
namespace IqraInfrastructure.Managers.Audio.Encoders
{
    ...
    {
        public static IAudioStreamEncoder CreateEncoder(AudioEncodingTypeEnum type, int sampleRate, int bitsPerSample, int frameDurationMs)
        {
            return type switch
            {
                ...
                AudioEncodingTypeEnum.G722 => new G722StreamEncoder(),
                AudioEncodingTypeEnum.G729 => new G729StreamEncoder(),
