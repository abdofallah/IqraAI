        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                try
                {
                    ...
                    long queuedCallsCount = await _callQueueRepository.GetActiveInboundCallCountForProcessingServerAsync(_serverConfig.Id, _serverConfig.RegionId);
                    ...
                    long activeCallCount = await _conversationStateRepository.GetActiveCallCountForServerAsync(_serverConfig.Id, _serverConfig.RegionId);
